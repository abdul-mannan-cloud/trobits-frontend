...
function AdBannerF() {
  ...
  return (
    <div className="flex justify-center p-6 animate-fade-in-up">
      ...
      <div
        ref={adRef}
        className="67c24fd7aa72d3d47fc083ad bg-gray-800 rounded-xl shadow-2xl flex items-center justify-center border border-gray-600" // More rounded, stronger shadow, border
...
const PriceGraph = () => {
  ...
  return (
    <div className="bg-gray-800 rounded-xl shadow-2xl p-6 h-[500px] transition-all duration-500 hover:shadow-3xl hover:scale-[1.02] border border-gray-600 animate-fade-in-up">
      {" "}
      {/* Larger height, more padding, stronger effects, border, animation */}
      <div
...
const SymbolInfo = () => {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      locale: "en",
      colorTheme: "dark",
      isTransparent: true, // Remains true for dark theme integration
    });
  ...
  return (
    <div
      className="w-full h-[500px] bg-gray-800 rounded-xl shadow-2xl p-6 transition-all duration-500 hover:shadow-3xl hover:scale-[1.02] border border-gray-600 animate-fade-in-up" // Larger height, more padding, stronger effects, border, animation
      ref={infoRef}
    >
...
const CryptoCalendar = () => {
  ...
  return (
    <div
      className="rounded-xl shadow-2xl p-6 bg-gray-800 text-gray-200 h-full min-h-[300px] transition-all duration-500 hover:shadow-3xl hover:scale-[1.02] flex flex-col items-center justify-center border border-gray-600 animate-fade-in-up" // More padding, stronger effects, min-height, flex-col, border, animation
      ref={calendarRef}
    >
      <div
